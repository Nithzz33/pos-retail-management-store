    ...
    <div className="min-h-screen bg-transparent py-12">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div className="flex items-center gap-4 bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/20 shadow-sm">
            <div className="bg-gray-900/80 p-3 rounded-2xl text-white backdrop-blur-sm">
              <ShoppingBag size={32} />
            </div>
            <div>
        ...
        {filteredSales.length === 0 ? (
          <div className="bg-white/40 backdrop-blur-md rounded-3xl p-12 text-center border border-white/20 shadow-sm">
          ...
          <div className="space-y-4">
            {filteredSales.map((sale) => (
              <motion.div 
                ...
                className="bg-white/40 backdrop-blur-md rounded-3xl border border-white/20 overflow-hidden hover:shadow-md transition-shadow"
              >
                <div 
                ...
                <AnimatePresence>
                  {expandedSaleId === sale.id && (
                    <motion.div 
                      ...
                      className="border-t border-white/10 bg-white/10 backdrop-blur-sm"
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div>
                            ...
                            <div className="space-y-3">
                              {sale.items.map((item, idx) => {
                                ...
                                return (
                                  <div key={idx} className="flex items-center justify-between bg-white/40 backdrop-blur-md p-3 rounded-2xl border border-white/20 shadow-sm">
                                    <div className="flex items-center gap-3">
                                      <div className="w-10 h-10 bg-white/40 rounded-lg overflow-hidden p-1 backdrop-blur-sm">
                          ...
                          <div className="space-y-6">
                            <div>
                              ...
                              <div className="bg-white/40 backdrop-blur-md p-6 rounded-3xl border border-white/20 shadow-sm space-y-3">
