  ...
  return (
    <div className="relative h-full">
      ...
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex gap-4 sticky top-0 z-10">
            ...
            .map(product => (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  <p className={`text-[10px] font-black px-1.5 py-0.5 rounded-md ${product.stock > 10 ? 'bg-green-50 text-green-600' : product.stock > 0 ? 'bg-yellow-50 text-yellow-600' : 'bg-red-50 text-red-600'}`}>
                    Stock: {product.stock}
                  </p>
                </div>
        ...
        {isCartOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed top-0 right-0 bottom-0 w-full max-w-md bg-white shadow-2xl z-[90] flex flex-col"
            >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    <input 
                      ...
                      className="w-full px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-sm font-bold focus:ring-2 focus:ring-[#FF3269] outline-none"
                    />
                  </div>
                  <div className="space-y-1">
                    <input 
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <input 
                      ...
                      className="w-24 px-2 py-1 bg-white border border-gray-200 rounded-lg text-right font-black text-[#FF3269] focus:ring-2 focus:ring-[#FF3269] outline-none"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2">
                  {lastSale && (
                    <button 
                      ...
                      className="col-span-2 flex items-center justify-center gap-2 bg-blue-50 text-blue-600 p-4 rounded-2xl hover:bg-blue-100 transition-all font-black text-sm mb-2"
                    >
                  ...
                  <button 
                    ...
                    className="flex flex-col items-center gap-2 bg-white border-2 border-gray-100 p-4 rounded-2xl hover:border-green-500 hover:text-green-600 transition-all disabled:opacity-50 group"
                  >
                  ...
                  <button 
                    ...
                    disabled={posCart.length === 0 || isProcessingSale}
                    className="flex flex-col items-center gap-2 bg-white border-2 border-gray-100 p-4 rounded-2xl hover:border-blue-500 hover:text-blue-600 transition-all disabled:opacity-50 group"
                  >
