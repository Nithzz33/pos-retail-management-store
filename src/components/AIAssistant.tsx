  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100]">
      <motion.button
        ...
        className="w-16 h-16 bg-[#FF3269] rounded-full shadow-2xl flex items-center justify-center text-white relative group"
      >
        <div className="absolute inset-0 bg-[#FF3269] rounded-full animate-ping opacity-20 group-hover:animate-none" />
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="bg-white p-3 rounded-2xl rounded-tl-none shadow-sm border border-gray-100 flex items-center gap-2">
                    <Loader2 className="animate-spin text-[#FF3269]" size={14} />
            ...
            <div className="p-4 bg-white border-t border-gray-100">
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 bg-gray-50 border-none rounded-xl py-3 px-4 text-xs font-bold outline-none focus:ring-2 focus:ring-[#FF3269]"
                />
                <button
                  onClick={() => handleQuery()}
                  disabled={isLoading || !message.trim()}
                  className="bg-[#FF3269] text-white p-3 rounded-xl shadow-lg shadow-[#FF3269]/20 hover:bg-[#E62D5E] transition-all disabled:opacity-50"
                >
                  <Send size={18} />
                </button>
              </div>
